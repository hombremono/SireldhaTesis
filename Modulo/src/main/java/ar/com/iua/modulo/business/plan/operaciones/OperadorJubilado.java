 ...
 */
public class OperadorJubilado extends OperadorAbstracto {
    ...
    void cargarOperador(PlanResultado resultados, Plan_Criterio criterio, IPlanService planService) {
        this.presenciaJubilado = false;
        for (Persona integrante : resultados.obtenerIntegrantes()) {
            if (integrante.getNroCarnetJubilacion() != null) {
                this.presenciaJubilado = true;
            }
        }
    }
