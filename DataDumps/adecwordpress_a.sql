...
--
-- Host: 127.0.0.1    Database: adecwordpress_a
-- ------------------------------------------------------
...
CREATE TABLE `persona` (
  ...
  KEY `fk_Telefono_idx` (`id_Telefono`),
  ...
  CONSTRAINT `fk_persona_11` FOREIGN KEY (`id_Telefono`) REFERENCES `telefono` (`id_Telefono`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2017-06-08 22:05:58
